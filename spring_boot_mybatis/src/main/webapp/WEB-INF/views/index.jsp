...
<html>
	...
	<body>
		...
		<h3>Mybatis 사용</h3>
		<a href="<c:url value='/product/productListAll'/>">전체 상품 조회</a> <br>
		<a href="<c:url value='/product/productNewForm'/>">상품 등록</a>  <br>
		
		<hr>
		이미지 출력<br>
		<!-- resources에서 image로 매핑 설정한 경우 -->
