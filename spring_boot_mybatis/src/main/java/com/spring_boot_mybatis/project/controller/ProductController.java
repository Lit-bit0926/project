...
public class ProductController {
	...
	//시작 시 index.jsp 페이지 열기 // 요청 url : http://localhost:8090/
	@RequestMapping("/")
	public String index() {
		return "index";
	}
	...
	// 상품 정보 수정 폼 열기
	// (수정 할 데이터를 미리 출력하기 위해 상품 상세 정보 결과 출력)
	...
	// 상품 검색2 처리
	// 편법: Ajax에게 데이터가 아닌 뷰 페이지 반환. Ajax에서 html() 사용해서 뷰페이지 삽입
